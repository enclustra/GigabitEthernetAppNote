...
proc create_hier_cell_hier_ps { parentCell nameHier } {
  ...
  if { $parentCell eq "" || $nameHier eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2092 -severity "ERROR" "create_hier_cell_hier_ps() - Empty argument(s)!"}
     return
  }
  ...
  create_bd_pin -dir O -type clk Clk75
  ...
  create_bd_pin -dir I -from 3 -to 0 -type intr pl_ps_irq0
...
sclk_out#miso_mo1#mo2#mo3#mosi_mi0#n_ss_out#clk_for_lpbk#gpio0[7]#gpio0[8]#gpio0[9]#scl_out#sda_out#gpio0[12]#sdio0_data_out[0]#sdio0_data_out[1]#sdio0_data_out[2]#sdio0_data_out[3]#sdio0_data_out[4]#sdio0_data_out[5]#sdio0_data_out[6]#sdio0_data_out[7]#sdio0_cmd_out#sdio0_clk_out#gpio0[23]#gpio0[24]#gpio0[25]#rgmii_tx_clk#rgmii_txd[0]#rgmii_txd[1]#rgmii_txd[2]#rgmii_txd[3]#rgmii_tx_ctl#rgmii_rx_clk#rgmii_rxd[0]#rgmii_rxd[1]#rgmii_rxd[2]#rgmii_rxd[3]#rgmii_rx_ctl#rxd#txd#gpio1[40]#gpio1[41]#gpio1[42]#gpio1[43]#gpio1[44]#sdio1_cd_n#sdio1_data_out[0]#sdio1_data_out[1]#sdio1_data_out[2]#sdio1_data_out[3]#sdio1_cmd_out#sdio1_clk_out#ulpi_clk_in#ulpi_dir#ulpi_tx_data[2]#ulpi_nxt#ulpi_tx_data[0]#ulpi_tx_data[1]#ulpi_stp#ulpi_tx_data[3]#ulpi_tx_data[4]#ulpi_tx_data[5]#ulpi_tx_data[6]#ulpi_tx_data[7]#rgmii_tx_clk#rgmii_txd[0]#rgmii_txd[1]#rgmii_txd[2]#rgmii_txd[3]#rgmii_tx_ctl#rgmii_rx_clk#rgmii_rxd[0]#rgmii_rxd[1]#rgmii_rxd[2]#rgmii_rxd[3]#rgmii_rx_ctl#gem0_mdc#gem0_mdio_out} \
   ...
   CONFIG.PSU__CRL_APB__PL2_REF_CTRL__DIVISOR0 {20} \
   CONFIG.PSU__CRL_APB__PL2_REF_CTRL__DIVISOR1 {1} \
   CONFIG.PSU__CRL_APB__PL2_REF_CTRL__FREQMHZ {75} \
...
Port;FD4A0000;FD4AFFFF;1|FPD;DPDMA;FD4C0000;FD4CFFFF;1|FPD;DDR_XMPU5_CFG;FD050000;FD05FFFF;1|FPD;DDR_XMPU4_CFG;FD040000;FD04FFFF;1|FPD;DDR_XMPU3_CFG;FD030000;FD03FFFF;1|FPD;DDR_XMPU2_CFG;FD020000;FD02FFFF;1|FPD;DDR_XMPU1_CFG;FD010000;FD01FFFF;1|FPD;DDR_XMPU0_CFG;FD000000;FD00FFFF;1|FPD;DDR_QOS_CTRL;FD090000;FD09FFFF;1|FPD;DDR_PHY;FD080000;FD08FFFF;1|DDR;DDR_LOW;0;7FFFFFFF;1|DDR;DDR_HIGH;800000000;87FFFFFFF;1|FPD;DDDR_CTRL;FD070000;FD070FFF;1|LPD;Coresight;FE800000;FEFFFFFF;1|LPD;CSU_DMA;FFC80000;FFC9FFFF;1|LPD;CSU;FFCA0000;FFCAFFFF;1|LPD;CRL_APB;FF5E0000;FF85FFFF;1|FPD;CRF_APB;FD1A0000;FD2DFFFF;1|FPD;CCI_REG;FD5E0000;FD5EFFFF;1|LPD;CAN1;FF070000;FF07FFFF;0|LPD;CAN0;FF060000;FF06FFFF;0|FPD;APU;FD5C0000;FD5CFFFF;1|LPD;APM_INTC_IOU;FFA20000;FFA2FFFF;1|LPD;APM_FPD_LPD;FFA30000;FFA3FFFF;1|FPD;APM_5;FD490000;FD49FFFF;1|FPD;APM_0;FD0B0000;FD0BFFFF;1|LPD;APM2;FFA10000;FFA1FFFF;1|LPD;APM1;FFA00000;FFA0FFFF;1|LPD;AMS;FFA50000;FFA5FFFF;1|FPD;AFI_5;FD3B0000;FD3BFFFF;1|FPD;AFI_4;FD3A0000;FD3AFFFF;1|FPD;AFI_3;FD390000;FD39FFFF;1|FPD;AFI_2;FD380000;FD38FFFF;1|FPD;AFI_1;FD370000;FD37FFFF;1|FPD;AFI_0;FD360000;FD36FFFF;1|LPD;AFIFM6;FF9B0000;FF9BFFFF;1|FPD;ACPU_GIC;F9010000;F907FFFF;1} \
  ...
  connect_bd_intf_net -intf_net Conn2 [get_bd_intf_pins M01_AXI] [get_bd_intf_pins axi_interconnect_0/M01_AXI]
  connect_bd_intf_net -intf_net Conn3 [get_bd_intf_pins S02_AXI] [get_bd_intf_pins axi_interconnect_1/S02_AXI]
  connect_bd_intf_net -intf_net Conn4 [get_bd_intf_pins S01_AXI] [get_bd_intf_pins axi_interconnect_1/S01_AXI]
  connect_bd_intf_net -intf_net Conn5 [get_bd_intf_pins S00_AXI] [get_bd_intf_pins axi_interconnect_1/S00_AXI]
  connect_bd_intf_net -intf_net axi_interconnect_1_M00_AXI [get_bd_intf_pins axi_interconnect_1/M00_AXI] [get_bd_intf_pins zynq_ultra_ps_e/S_AXI_HP0_FPD]
  ...
  connect_bd_intf_net -intf_net zynq_ultra_ps_e_M_AXI_HPM0_LPD [get_bd_intf_pins axi_interconnect_0/S00_AXI] [get_bd_intf_pins zynq_ultra_ps_e/M_AXI_HPM0_LPD]
  ...
  connect_bd_net -net ddr4_c0_ddr4_ui_clk [get_bd_pins maxihpm0_fpd_aclk] [get_bd_pins zynq_ultra_ps_e/maxihpm0_fpd_aclk]
  connect_bd_net -net ps_sys_rst_interconnect_aresetn [get_bd_pins axi_interconnect_0/ARESETN] [get_bd_pins axi_interconnect_1/ARESETN] [get_bd_pins ps_sys_rst/interconnect_aresetn]
  connect_bd_net -net ps_sys_rst_peripheral_aresetn [get_bd_pins peripheral_aresetn] [get_bd_pins axi_interconnect_0/M00_ARESETN] [get_bd_pins axi_interconnect_0/M01_ARESETN] [get_bd_pins axi_interconnect_0/S00_ARESETN] [get_bd_pins axi_interconnect_1/M00_ARESETN] [get_bd_pins axi_interconnect_1/S00_ARESETN] [get_bd_pins axi_interconnect_1/S01_ARESETN] [get_bd_pins axi_interconnect_1/S02_ARESETN] [get_bd_pins ps_sys_rst/peripheral_aresetn]
  ...
  connect_bd_net -net zynq_ultra_ps_e_dp_aux_data_oe_n [get_bd_pins DP_AUX_OE] [get_bd_pins zynq_ultra_ps_e/dp_aux_data_oe_n]
  connect_bd_net -net zynq_ultra_ps_e_dp_aux_data_out [get_bd_pins DP_AUX_OUT] [get_bd_pins zynq_ultra_ps_e/dp_aux_data_out]
  connect_bd_net -net zynq_ultra_ps_e_pl_clk0 [get_bd_pins Clk100] [get_bd_pins zynq_ultra_ps_e/pl_clk0]
  connect_bd_net -net zynq_ultra_ps_e_pl_clk1 [get_bd_pins Clk50] [get_bd_pins zynq_ultra_ps_e/pl_clk1]
  connect_bd_net -net zynq_ultra_ps_e_pl_clk2 [get_bd_pins Clk75] [get_bd_pins axi_interconnect_0/ACLK] [get_bd_pins axi_interconnect_0/M00_ACLK] [get_bd_pins axi_interconnect_0/M01_ACLK] [get_bd_pins axi_interconnect_0/S00_ACLK] [get_bd_pins axi_interconnect_1/ACLK] [get_bd_pins axi_interconnect_1/M00_ACLK] [get_bd_pins axi_interconnect_1/S00_ACLK] [get_bd_pins axi_interconnect_1/S01_ACLK] [get_bd_pins axi_interconnect_1/S02_ACLK] [get_bd_pins ps_sys_rst/slowest_sync_clk] [get_bd_pins zynq_ultra_ps_e/maxihpm0_lpd_aclk] [get_bd_pins zynq_ultra_ps_e/pl_clk2] [get_bd_pins zynq_ultra_ps_e/saxihp0_fpd_aclk]
  connect_bd_net -net zynq_ultra_ps_e_pl_resetn0 [get_bd_pins Rst_N] [get_bd_pins ps_sys_rst/ext_reset_in] [get_bd_pins zynq_ultra_ps_e/pl_resetn0]

  # Restore current instance
  current_bd_instance $oldCurInst
}

# Hierarchical cell: hier_ethernet
proc create_hier_cell_hier_ethernet { parentCell nameHier } {

  variable script_folder

  if { $parentCell eq "" || $nameHier eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2092 -severity "ERROR" "create_hier_cell_hier_ethernet() - Empty argument(s)!"}
     return
  }
  ...
  create_bd_intf_pin -mode Slave -vlnv xilinx.com:interface:aximm_rtl:1.0 Ethernet_AXI
  ...
  create_bd_pin -dir O -type rst mm2s_cntrl_reset_out_n
  ...
  create_bd_pin -dir O -type rst s2mm_sts_reset_out_n
  ...
  connect_bd_intf_net -intf_net Conn3 [get_bd_intf_pins DMA_AXI_LITE] [get_bd_intf_pins axi_dma_0/S_AXI_LITE]
  connect_bd_intf_net -intf_net Conn4 [get_bd_intf_pins M_AXI_MM2S] [get_bd_intf_pins axi_dma_0/M_AXI_MM2S]
  connect_bd_intf_net -intf_net Conn5 [get_bd_intf_pins sfp] [get_bd_intf_pins axi_ethernet_0/sfp]
  ...
  connect_bd_intf_net -intf_net hier_ps_M01_AXI [get_bd_intf_pins Ethernet_AXI] [get_bd_intf_pins axi_ethernet_0/s_axi]
  connect_bd_intf_net -intf_net mgt_clk_0_1 [get_bd_intf_pins mgt_clk] [get_bd_intf_pins axi_ethernet_0/mgt_clk]

  # Create port connections
  connect_bd_net -net axi_dma_0_mm2s_cntrl_reset_out_n [get_bd_pins mm2s_cntrl_reset_out_n] [get_bd_pins axi_dma_0/mm2s_cntrl_reset_out_n] [get_bd_pins axi_ethernet_0/axi_txc_arstn]
  connect_bd_net -net axi_dma_0_mm2s_introut [get_bd_pins axi_dma_0/mm2s_introut] [get_bd_pins xlconcat_0/In0]
  connect_bd_net -net axi_dma_0_mm2s_prmry_reset_out_n [get_bd_pins mm2s_prmry_reset_out_n] [get_bd_pins axi_dma_0/mm2s_prmry_reset_out_n] [get_bd_pins axi_ethernet_0/axi_txd_arstn]
  connect_bd_net -net axi_dma_0_s2mm_introut [get_bd_pins axi_dma_0/s2mm_introut] [get_bd_pins xlconcat_0/In1]
  connect_bd_net -net axi_dma_0_s2mm_prmry_reset_out_n [get_bd_pins s2mm_prmry_reset_out_n] [get_bd_pins axi_dma_0/s2mm_prmry_reset_out_n] [get_bd_pins axi_ethernet_0/axi_rxd_arstn]
  connect_bd_net -net axi_dma_0_s2mm_sts_reset_out_n [get_bd_pins s2mm_sts_reset_out_n] [get_bd_pins axi_dma_0/s2mm_sts_reset_out_n] [get_bd_pins axi_ethernet_0/axi_rxs_arstn]
  connect_bd_net -net axi_ethernet_0_gtpowergood [get_bd_pins gtpowergood] [get_bd_pins axi_ethernet_0/gtpowergood]
  ...
  connect_bd_net -net axi_ethernet_0_mmcm_locked_out [get_bd_pins mmcm_locked_out] [get_bd_pins axi_ethernet_0/mmcm_locked_out]
  connect_bd_net -net axi_ethernet_0_rxuserclk2_out [get_bd_pins rxuserclk2_out] [get_bd_pins axi_ethernet_0/rxuserclk2_out]
  connect_bd_net -net axi_ethernet_0_userclk2_out [get_bd_pins userclk2_out] [get_bd_pins axi_ethernet_0/userclk2_out]
  connect_bd_net -net clk_wiz_0_clk_out1 [get_bd_pins ref_clk] [get_bd_pins axi_ethernet_0/ref_clk]
  connect_bd_net -net ps_sys_rst_peripheral_aresetn [get_bd_pins s_axi_lite_resetn] [get_bd_pins axi_dma_0/axi_resetn] [get_bd_pins axi_ethernet_0/s_axi_lite_resetn]
  ...
  connect_bd_net -net zynq_ultra_ps_e_pl_clk2 [get_bd_pins axis_clk] [get_bd_pins axi_dma_0/m_axi_mm2s_aclk] [get_bd_pins axi_dma_0/m_axi_s2mm_aclk] [get_bd_pins axi_dma_0/m_axi_sg_aclk] [get_bd_pins axi_dma_0/s_axi_lite_aclk] [get_bd_pins axi_ethernet_0/axis_clk] [get_bd_pins axi_ethernet_0/s_axi_lite_clk]

  # Restore current instance
  current_bd_instance $oldCurInst
}

# Hierarchical cell: hier_ddr4
proc create_hier_cell_hier_ddr4 { parentCell nameHier } {

  variable script_folder

  if { $parentCell eq "" || $nameHier eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2092 -severity "ERROR" "create_hier_cell_hier_ddr4() - Empty argument(s)!"}
     return
  }
  ...
  # Create interface connections
  connect_bd_intf_net -intf_net C0_SYS_CLK_1 [get_bd_intf_pins C0_SYS_CLK] [get_bd_intf_pins ddr4/C0_SYS_CLK]
  ...
  connect_bd_intf_net -intf_net ddr4_C0_DDR4 [get_bd_intf_pins C0_DDR4] [get_bd_intf_pins ddr4/C0_DDR4]
...
# Hierarchical cell: hier_dbg
proc create_hier_cell_hier_dbg { parentCell nameHier } {

  variable script_folder

  if { $parentCell eq "" || $nameHier eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2092 -severity "ERROR" "create_hier_cell_hier_dbg() - Empty argument(s)!"}
     return
  }
  ...
  create_bd_pin -dir O -from 0 -to 0 LED2
  create_bd_pin -dir O -from 0 -to 0 LED3
  create_bd_pin -dir O -from 0 -to 0 PL_LED2_N
  ...
  # Create port connections
  connect_bd_net -net CLK1_1 [get_bd_pins CLK1] [get_bd_pins c_counter_binary_1/CLK]
  ...
  connect_bd_net -net util_vector_logic_0_Res [get_bd_pins PL_LED2_N] [get_bd_pins util_vector_logic_0/Res]
  connect_bd_net -net xlconcat_1_dout [get_bd_pins util_reduced_logic_0/Op1] [get_bd_pins xlconcat_1/dout]
  connect_bd_net -net xlslice_0_Dout [get_bd_pins LED3] [get_bd_pins xlslice_0/Dout]
  connect_bd_net -net xlslice_1_Dout [get_bd_pins LED2] [get_bd_pins xlslice_1/Dout]
...
proc create_root_design { parentCell } {
  ...
  # Create instance: hier_dbg
  create_hier_cell_hier_dbg [current_bd_instance .] hier_dbg

  # Create instance: hier_ddr4
  create_hier_cell_hier_ddr4 [current_bd_instance .] hier_ddr4

  # Create instance: hier_ethernet
  create_hier_cell_hier_ethernet [current_bd_instance .] hier_ethernet

  # Create instance: hier_ps
  create_hier_cell_hier_ps [current_bd_instance .] hier_ps

  # Create interface connections
  connect_bd_intf_net -intf_net C0_SYS_CLK_1 [get_bd_intf_ports C0_SYS_CLK] [get_bd_intf_pins hier_ddr4/C0_SYS_CLK]
  connect_bd_intf_net -intf_net ddr4_C0_DDR4 [get_bd_intf_ports C0_DDR4] [get_bd_intf_pins hier_ddr4/C0_DDR4]
  connect_bd_intf_net -intf_net hier_ethernet_M_AXI_MM2S [get_bd_intf_pins hier_ethernet/M_AXI_MM2S] [get_bd_intf_pins hier_ps/S01_AXI]
  connect_bd_intf_net -intf_net hier_ethernet_M_AXI_S2MM [get_bd_intf_pins hier_ethernet/M_AXI_S2MM] [get_bd_intf_pins hier_ps/S02_AXI]
  connect_bd_intf_net -intf_net hier_ethernet_M_AXI_SG [get_bd_intf_pins hier_ethernet/M_AXI_SG] [get_bd_intf_pins hier_ps/S00_AXI]
  connect_bd_intf_net -intf_net hier_ethernet_sfp_0 [get_bd_intf_ports sfp] [get_bd_intf_pins hier_ethernet/sfp]
  connect_bd_intf_net -intf_net hier_ps_IIC_FPGA [get_bd_intf_ports IIC_FPGA] [get_bd_intf_pins hier_ps/IIC_FPGA]
  connect_bd_intf_net -intf_net hier_ps_M00_AXI [get_bd_intf_pins hier_ethernet/DMA_AXI_LITE] [get_bd_intf_pins hier_ps/M00_AXI]
  connect_bd_intf_net -intf_net hier_ps_M01_AXI [get_bd_intf_pins hier_ethernet/Ethernet_AXI] [get_bd_intf_pins hier_ps/M01_AXI]
  connect_bd_intf_net -intf_net hier_ps_M_AXI_HPM0_FPD [get_bd_intf_pins hier_ddr4/S00_AXI] [get_bd_intf_pins hier_ps/M_AXI_HPM0_FPD]
  connect_bd_intf_net -intf_net mgt_clk_0_1 [get_bd_intf_ports mgt_clk] [get_bd_intf_pins hier_ethernet/mgt_clk]

  # Create port connections
  connect_bd_net -net DP_AUX_IN_1 [get_bd_ports DP_AUX_IN] [get_bd_pins hier_ps/DP_AUX_IN]
  connect_bd_net -net DP_HPD_1 [get_bd_ports DP_HPD] [get_bd_pins hier_ps/DP_HPD]
  connect_bd_net -net ddr4_c0_ddr4_ui_clk [get_bd_pins hier_ddr4/c0_ddr4_ui_clk] [get_bd_pins hier_ps/maxihpm0_fpd_aclk]
  connect_bd_net -net hier_dbg_LED2 [get_bd_ports LED2] [get_bd_pins hier_dbg/LED2]
  connect_bd_net -net hier_dbg_LED3 [get_bd_ports LED3] [get_bd_pins hier_dbg/LED3]
  connect_bd_net -net hier_dbg_PL_LED2_N [get_bd_ports PL_LED2_N] [get_bd_pins hier_dbg/PL_LED2_N]
  connect_bd_net -net hier_ethernet_dout [get_bd_pins hier_ethernet/dout] [get_bd_pins hier_ps/pl_ps_irq0]
  connect_bd_net -net hier_ethernet_gtpowergood [get_bd_pins hier_dbg/In0] [get_bd_pins hier_ethernet/gtpowergood]
  connect_bd_net -net hier_ethernet_mm2s_cntrl_reset_out_n [get_bd_pins hier_dbg/In4] [get_bd_pins hier_ethernet/mm2s_cntrl_reset_out_n]
  connect_bd_net -net hier_ethernet_mm2s_prmry_reset_out_n [get_bd_pins hier_dbg/In1] [get_bd_pins hier_ethernet/mm2s_prmry_reset_out_n]
  connect_bd_net -net hier_ethernet_mmcm_locked_out [get_bd_pins hier_dbg/In2] [get_bd_pins hier_ethernet/mmcm_locked_out]
  connect_bd_net -net hier_ethernet_rxuserclk2_out [get_bd_pins hier_dbg/CLK] [get_bd_pins hier_ethernet/rxuserclk2_out]
  connect_bd_net -net hier_ethernet_s2mm_prmry_reset_out_n [get_bd_pins hier_dbg/In3] [get_bd_pins hier_ethernet/s2mm_prmry_reset_out_n]
  connect_bd_net -net hier_ethernet_s2mm_sts_reset_out_n [get_bd_pins hier_dbg/In5] [get_bd_pins hier_ethernet/s2mm_sts_reset_out_n]
  connect_bd_net -net hier_ethernet_userclk2_out [get_bd_pins hier_dbg/CLK1] [get_bd_pins hier_ethernet/userclk2_out]
  connect_bd_net -net hier_ps_Clk50 [get_bd_pins hier_ethernet/ref_clk] [get_bd_pins hier_ps/Clk50]
  connect_bd_net -net hier_ps_Clk75 [get_bd_pins hier_ethernet/axis_clk] [get_bd_pins hier_ps/Clk75]
  connect_bd_net -net hier_ps_Clk100 [get_bd_ports Clk100] [get_bd_pins hier_ps/Clk100]
  connect_bd_net -net hier_ps_DP_AUX_OE [get_bd_ports DP_AUX_OE] [get_bd_pins hier_ps/DP_AUX_OE]
  connect_bd_net -net hier_ps_DP_AUX_OUT [get_bd_ports DP_AUX_OUT] [get_bd_pins hier_ps/DP_AUX_OUT]
  connect_bd_net -net hier_ps_Rst_N [get_bd_ports Rst_N] [get_bd_pins hier_ddr4/ext_reset_in] [get_bd_pins hier_ps/Rst_N]
  connect_bd_net -net hier_ps_peripheral_aresetn [get_bd_pins hier_ethernet/s_axi_lite_resetn] [get_bd_pins hier_ps/peripheral_aresetn]

  # Create address segments
  assign_bd_address -offset 0x00000000 -range 0x80000000 -target_address_space [get_bd_addr_spaces hier_ethernet/axi_dma_0/Data_MM2S] [get_bd_addr_segs hier_ps/zynq_ultra_ps_e/SAXIGP2/HP0_DDR_LOW] -force
  assign_bd_address -offset 0xC0000000 -range 0x20000000 -target_address_space [get_bd_addr_spaces hier_ethernet/axi_dma_0/Data_MM2S] [get_bd_addr_segs hier_ps/zynq_ultra_ps_e/SAXIGP2/HP0_QSPI] -force
  assign_bd_address -offset 0x00000000 -range 0x80000000 -target_address_space [get_bd_addr_spaces hier_ethernet/axi_dma_0/Data_S2MM] [get_bd_addr_segs hier_ps/zynq_ultra_ps_e/SAXIGP2/HP0_DDR_LOW] -force
  assign_bd_address -offset 0xC0000000 -range 0x20000000 -target_address_space [get_bd_addr_spaces hier_ethernet/axi_dma_0/Data_S2MM] [get_bd_addr_segs hier_ps/zynq_ultra_ps_e/SAXIGP2/HP0_QSPI] -force
  assign_bd_address -offset 0x00000000 -range 0x80000000 -target_address_space [get_bd_addr_spaces hier_ethernet/axi_dma_0/Data_SG] [get_bd_addr_segs hier_ps/zynq_ultra_ps_e/SAXIGP2/HP0_DDR_LOW] -force
  assign_bd_address -offset 0xC0000000 -range 0x20000000 -target_address_space [get_bd_addr_spaces hier_ethernet/axi_dma_0/Data_SG] [get_bd_addr_segs hier_ps/zynq_ultra_ps_e/SAXIGP2/HP0_QSPI] -force
  assign_bd_address -offset 0x80000000 -range 0x00010000 -target_address_space [get_bd_addr_spaces hier_ps/zynq_ultra_ps_e/Data] [get_bd_addr_segs hier_ethernet/axi_dma_0/S_AXI_LITE/Reg] -force
  assign_bd_address -offset 0x80040000 -range 0x00040000 -target_address_space [get_bd_addr_spaces hier_ps/zynq_ultra_ps_e/Data] [get_bd_addr_segs hier_ethernet/axi_ethernet_0/s_axi/Reg0] -force
  assign_bd_address -offset 0x000400000000 -range 0x80000000 -target_address_space [get_bd_addr_spaces hier_ps/zynq_ultra_ps_e/Data] [get_bd_addr_segs hier_ddr4/ddr4/C0_DDR4_MEMORY_MAP/C0_DDR4_ADDRESS_BLOCK] -force

  # Exclude Address Segments
  exclude_bd_addr_seg -offset 0x000800000000 -range 0x000100000000 -target_address_space [get_bd_addr_spaces hier_ethernet/axi_dma_0/Data_MM2S] [get_bd_addr_segs hier_ps/zynq_ultra_ps_e/SAXIGP2/HP0_DDR_HIGH]
  exclude_bd_addr_seg -offset 0xFF000000 -range 0x01000000 -target_address_space [get_bd_addr_spaces hier_ethernet/axi_dma_0/Data_MM2S] [get_bd_addr_segs hier_ps/zynq_ultra_ps_e/SAXIGP2/HP0_LPS_OCM]
  exclude_bd_addr_seg -offset 0x000800000000 -range 0x000100000000 -target_address_space [get_bd_addr_spaces hier_ethernet/axi_dma_0/Data_S2MM] [get_bd_addr_segs hier_ps/zynq_ultra_ps_e/SAXIGP2/HP0_DDR_HIGH]
  exclude_bd_addr_seg -offset 0xFF000000 -range 0x01000000 -target_address_space [get_bd_addr_spaces hier_ethernet/axi_dma_0/Data_S2MM] [get_bd_addr_segs hier_ps/zynq_ultra_ps_e/SAXIGP2/HP0_LPS_OCM]
  exclude_bd_addr_seg -offset 0x000800000000 -range 0x000100000000 -target_address_space [get_bd_addr_spaces hier_ethernet/axi_dma_0/Data_SG] [get_bd_addr_segs hier_ps/zynq_ultra_ps_e/SAXIGP2/HP0_DDR_HIGH]
  exclude_bd_addr_seg -offset 0xFF000000 -range 0x01000000 -target_address_space [get_bd_addr_spaces hier_ethernet/axi_dma_0/Data_SG] [get_bd_addr_segs hier_ps/zynq_ultra_ps_e/SAXIGP2/HP0_LPS_OCM]
